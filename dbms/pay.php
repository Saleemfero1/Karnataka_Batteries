<html>
<head>
    <title>karnataka payment</title>
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/js" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js">
    <link rel="stylesheet" type="text/js" href="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js">
    <style>
...
.form-control:focus {
    ...
    <body>
        <script type="text/javascript">
            function message() {
                alert("your order has been placed and will reach you soon");
                    ...
                    <div class="collapse show p-3 pt-0" id="collapseExample">
                        <div class="row">
                            <div class="col-lg-5 mb-lg-0 mb-3">
                             <!--   <p class="h4 mb-0">Summary</p>
                                <p class="mb-0"><span class="fw-bold">Product:</span><span class="c-green">: Name of product</span> </p>
                                if u want add product name bro here u can add product name from database by using variable otherwise leave it  -->
                               <!-- <p class="mb-0"> <span class="fw-bold">Price:</span> <span class="c-green">:$452.90</span>-->
                                  <!--if u want add product price bro here u can add product price from database by using variable otherwise leave it  </p>
                                <p class="mb-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque nihil neque quisquam aut repellendus, dicta vero? Animi dicta cupiditate, facilis provident quibusdam ab quis, iste harum ipsum hic, nemo qui!</p>-->
                            </div>
                            <div class="col-lg-7">
                                <!--this is the main form you need to add this values into database-->
                                <form action="message.php" method="POST" class="form" >
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form__div"> <input type="text" class="form-control" placeholder="" id="Cno" name="Cno"> <label for="" class="form__label">Card Number</label> </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form__div"> <input type="text" class="form-control" placeholder=" " name="Exp_Date" id="Exp_Date"> <label for="" class="form__label">MM / yy</label> </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form__div"> <input type="password" class="form-control" placeholder=" "> <label for="" class="form__label" name="cvv" id="cvv">cvv code</label> </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form__div"> <input type="text" class="form-control" placeholder=" "> <label for="" class="form__label" name="uname" id="uname">name on the card</label> </div>
                                        </div>
                                        <div class="col-12">
                                          <div class="btn btn-primary payment" onclick="
                                          window.location.href='message.php'">Pay</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
